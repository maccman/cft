...
(function() {
  var cft, compile, compileToFile, each, eachFile, exec, fs, indent, mkdir, parseOptions, path, preprocessArgs, printUsage, printVersion, read, stripExtension, sys,
    __slice = [].slice;
  ...
  exports.run = function(args) {
    ...
    if (options.preprocess) {
      ...
      return sys.puts(cft.preprocess(fs.readFileSync(infile, "utf8")));
      ...
      return read(process.stdin, function(source) {
        return sys.puts(cft.precompile(source));
      });
