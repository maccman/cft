  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_ECOExpression() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, cont, directive, indent) { return { type: 'eco', tag: 'expression', content: cont, directive: directive, indent: indent }})(pos0, result0[2], result0[3], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_ECOEscapedContent() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, cont, directive, indent) { return { type: 'eco', tag: 'escapedContent', content: cont, directive: directive, indent: indent }})(pos0, result0[3], result0[4], result0[5]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_ECOContent() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, cont, directive, indent) { return { type: 'eco', tag: 'content', content: cont, directive: directive, indent: indent }})(pos0, result0[3], result0[4], result0[5]);
        }
        if (result0 === null) {
          pos = pos0;
        }
